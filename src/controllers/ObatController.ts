...
class ObatController {
    create = async (req: Request, res: Response): Promise<any> => {
        try {
            const { nama_obat, jenis, satuan, harga_beli, harga_jual, stok, kode_suplier  } = req.body;

            const create =await db.tbl_obat.create({
                nama_obat, jenis, satuan, harga_beli, harga_jual, stok, kode_suplier
            })
